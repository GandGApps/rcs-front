...
namespace Kassa.Avalonia.Services.MagneticStripeReaders;
internal static class MscReaderLibServices
{
    public static void RegisterMsrReaderPosLib(IConfiguration configuration)
    {
        ...
        var msrReaderLib = Enum.TryParse<MsrReaderLib>(msrReaderLibString, true, out var pos) ? pos : MsrReaderLib.None;
